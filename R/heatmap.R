#' A version of heatmap.2 (gplots), that correctly handles integer vectors for
#' Rowv and Colv, allowing simple re-ordering of the dendrograms.
#' 
    ...
    ...) 
{
    ...
    if (!inherits(Rowv, "dendrogram") && !is.integer(Rowv)) {
    ...
    if (!inherits(Colv, "dendrogram") && !is.integer(Colv)) {
